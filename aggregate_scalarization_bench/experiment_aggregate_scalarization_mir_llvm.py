...
PROJECT_ROOT = "/mnt/fjx/Compiler_Experiment/aggregate_scalarization_bench"
...
def main():
    ...
    ap.add_argument("--target-seconds", type=float, default=3.0)
    ...
    out_dir = args.out_dir.strip() or os.path.join(PROJECT_ROOT, "results", f"run_{ts}")
