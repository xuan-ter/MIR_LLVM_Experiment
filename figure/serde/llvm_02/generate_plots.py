...
# Configuration
CSV_PATH = "/mnt/fjx/Compiler_Experiment/serde_test/results/LLVM/20260203_092042/experiment_results.csv"
OUTPUT_DIR = "/mnt/fjx/Compiler_Experiment/serde_test/results/LLVM/20260203_092042/plots"
...
def load_data(csv_path):
    ...
    for config_name, values in grouped_data.items():
        ...
        # Use LLVM_Pass as name if available, otherwise ConfigName
        name = values['llvm_pass']
        if name == 'N/A' or name == 'None' or name is None:
            name = config_name
        
        # Disambiguate based on ConfigName
        if config_name == 'EXP_000_DEFAULT':
            name = "Default"
        elif config_name == 'EXP_001_DISABLE_ALL':
