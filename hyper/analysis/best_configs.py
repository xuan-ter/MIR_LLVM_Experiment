...
DEFAULT_CSV_PATH = r"d:\MIR_LLVM\mir_-llvm\hyper\mir_llvm_hybrid_py\20260311_002430\experiment_results.csv"
DEFAULT_OUT_PATH = r"d:\MIR_LLVM\mir_-llvm\hyper\analysis\best_configs_summary.csv"
...
def main():
    parser = argparse.ArgumentParser(description="Find best configs from experiment_results.csv")
