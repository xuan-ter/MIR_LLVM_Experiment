...
# Configuration
CSV_PATH = "/mnt/fjx/Compiler_Experiment/serde_test/results/MIR/20260202_182339/experiment_results.csv"
OUTPUT_DIR = "/mnt/fjx/Compiler_Experiment/serde_test/results/MIR/20260202_182339/plots"
    ...
    with open(csv_path, 'r', encoding='utf-8') as f:
        ...
        for row in reader:
            ...
            try:
                ...
                # Use SerializationTime + DeserializationTime as total time
                total_time = float(row['SerializationTime(s)']) + float(row['DeserializationTime(s)'])
                grouped_data[config_name]['times'].append(total_time)
